...
版本索引回答“哪份是采用稿”，不回答“人物此刻知道什么”。恢复、换场和修订时仍按 `story-context.md` 回读相关正文；可在已有故事/场景注释中用 `templates/scene-context.md` 记当前场有效依据与采用后增量，不另维护一套事实数据库。压缩交接保留硬锁的限定词、来源、事件时点、开放伏笔和待复核后场；更新哈希不等于语义已复核。
