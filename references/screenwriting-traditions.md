...
| 场景只有概念判断，没有人物实际回应 | [John August：How to write a scene](https://johnaugust.com/2007/write-scene)，进入方式、脑内排演与草写；第 4 步"Where could the scene take place?"、第 6 步"长场还是短场"（2026-09-23 重读，接入 `stage-3c-script.md` §3c.2 事件轨：地点承载变化，不代替变化）；[Dee Rees / BAFTA 官方文字稿](https://static.bafta.org/uploads_pre_202411/transcripts/bafta_screenwriters_lecture_dee_rees.pdf)，PDF 第 12 页 index cards 与重写；[Tony Gilroy / BAFTA 2013 原讲稿](https://www.bafta.org/media-centre/press-releases/screenwriters-lecture-series-2013-tony-gilroy/)，律师处境、片段与对话试写段 | 不确定时用真实片段试出人物，再回写故事；不要求全部任务先试写，不规定数量。Rees 年份不作为本次已核事实 |
